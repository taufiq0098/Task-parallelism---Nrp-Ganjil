...
TA 2025-2026
InfoDetailNamaTaufiq MahfudinNRP15-2024-161JenisTask Parallelism (NRP Ganjil)ProdiInformatika - Fakultas Teknologi IndustriInstitusiInstitut Teknologi Nasional Bandung
...
Image Processing — manipulasi pixel (resize + grayscale)
Database Query — agregasi data dari 50.000 baris
File Compression — buat file dan zip menggunakan zipfile
...
5. Analisis Output
BuktiPenjelasanSemua task start bersamaanTask 1, 2, 3 muncul di timestamp yang sama karena .start() dipanggil sangat cepatLog saling interleaveTask 3 sudah DONE sementara Task 1 masih berjalan — tidak mungkin terjadi kalau sequentialTask berbeda-bedaTask 1: komputasi pixel, Task 2: agregasi data, Task 3: I/O file — inilah ciri Task ParallelismEfisiensi waktuParalel: 0.41 detik vs Sequential estimasi: ~1.2 detik
